...
class TestWords(unittest.TestCase):
    ...
    def test_record(self):
        record_model = {'word': 'zoo', 'nb_records': 238, 'avg_%CA': 68.22783018867923, 'avg_nb_records': 2.2452830188679247, 
        'nb_classrooms': 26, 'nb_letters': 3, 'nb_students': 106, 'avg_time_reaction': 1.7610363443396226}
    ...
    def test_endpoint_status(self):
        response_model = {
            ...
            "data": [
                    {
                    "nb_classrooms": 26,
                    "avg_%CA": 68.22783018867923,
                    "word": "zoo",
                    "nb_letters": 3,
                    "nb_records": 238,
                    "nb_students": 106,
                    "avg_time_reaction": 1.7610363443396226,
                    "avg_nb_records": 2.2452830188679247
                    },
                    {
                    "nb_classrooms": 37,
                    "avg_%CA": 64.25467532467532,
                    "word": "sac",
                    "nb_letters": 3,
                    "nb_records": 739,
                    "nb_students": 270,
                    "avg_time_reaction": 2.201994038961039,
                    "avg_nb_records": 2.3993506493506493
                    }
                ],
            "words": [
                    {
